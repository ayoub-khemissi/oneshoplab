...
import { DiscordGlyph, LocaleSwitcher, ScrollHidingHeader, ThemeToggle } from '@/shared/ui';
...
export async function SiteHeader() {
  ...
  return (
    <>
      {/* Offered only to someone with an account to notify — the header is
          where the session is already resolved, and it renders on every
          screen. */}
      <PushOptInPrompt signedIn={Boolean(user?.id)} />
      <ScrollHidingHeader>
