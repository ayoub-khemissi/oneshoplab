  ...
  return (
    <main className="flex-1 px-4 md:px-10 py-6 md:py-10 max-w-3xl w-full mx-auto">
      <article className="prose prose-sm dark:prose-invert max-w-none leading-relaxed">
        ...
        <h2>7. Connecting Your Store</h2>
        <p>
          The Service can connect to your store on Shopify, WooCommerce or Wix — through our plugin,
          our published app, or a site key you generate. Connecting is your decision and you may
          revoke it at any time from the Integrations tab, from your store&apos;s own admin, or by
          uninstalling the plugin or app.
        </p>
        <p>
          <strong>Nothing is written to your store without your approval.</strong> A generation
          stays a proposal until you approve it; an approved change is queued and applied by the
          connection, and can be undone from the Service as long as your store still holds the value
          we replaced. You remain the publisher of everything on your store: you are responsible for
          reviewing what you approve, for its accuracy, and for its compliance with your obligations
          (consumer information, labelling, advertising rules, the terms of your e-commerce platform
          and of your marketplaces).
        </p>
        <p>
          You confirm that you are authorised to grant this access for the store you connect, and
          that you will keep your platform credentials secure. We access only what the connection
          declares: your product catalogue and the fields you asked us to change. We do not read
          your orders, your customers or your payment data.
        </p>
        <p>
          <strong>Keep your own backups.</strong> Your platform is the system of record, and its own
          tooling (revisions, exports, backups) is what protects your catalogue. To the extent
          permitted by law, we are not liable for changes applied through a connection you
          authorised, for content published on your store, for lost sales, lost search rankings,
          conversion changes, or any other financial loss arising from your use of the Output —
          including where a change was applied automatically after your approval.
        </p>

        <h2>8. Notifications</h2>
        <p>
          With your permission, the Service can send notifications to your browser or to the app
          installed from an application store, to tell you that a generation finished, an audit
          completed, or a store connection needs attention. You may withdraw that permission at any
          time from your account settings or from your device&apos;s own settings; notifications are
          never a condition of using the Service, and we do not use them for advertising.
        </p>
        <p>
          Notifications are delivered by the push service of your browser or operating system
          (Google, Apple, Mozilla or Microsoft depending on your device). Delivery is best-effort
          and depends on that service and on your device&apos;s network and settings; a notification
          that does not arrive is never a substitute for the information available in the Service
          itself.
        </p>

        <h2>9. Mobile Applications</h2>
        <p>
          Where we publish an application on Google Play or the Apple App Store, that application
          gives access to the same Service and these Terms apply to it in full. The store&apos;s own
          terms also apply to the download and to any purchase made through it. The application
          requires an internet connection and an account; it is not a separate product and carries
          no separate fee.
        </p>
        <p>
          For applications obtained from the Apple App Store: this agreement is between you and us,
          not with Apple; Apple has no obligation to furnish maintenance or support; in the event of
          a failure to conform to any applicable warranty you may notify Apple, which may refund the
          purchase price (if any) and, to the maximum extent permitted by law, has no other warranty
          obligation; we are responsible for any claim relating to the application; and Apple and
          its subsidiaries are third-party beneficiaries of these Terms with the right to enforce
          them against you.
        </p>
        ...
        <h2>11. Third-Party AI Providers and Services</h2>
        <p>
        ...
        <p>
          In plain words: the Service proposes, you decide, and your store is yours. We are not
          responsible for what you choose to publish, for how a marketplace, a search engine or a
          customer reacts to it, for sales you did or did not make, for a ranking that moved, for
          content that turned out to be inaccurate or non-compliant, or for anything a third-party
          platform, plugin or AI provider does on its own side. What we owe you is the Service
          working as described; the commercial outcome is yours.
        </p>
        <p>
        ...
        <p>
          The Service is operated from the European Union and complies with the regimes that apply
          to it: Regulation (EU) 2016/679 (GDPR) and the French Data Protection Act for personal
          data; Directive 2002/58/EC (ePrivacy), as implemented in France, for cookies and for the
          consent behind notifications; Regulation (EU) 2022/2065 (Digital Services Act) for the
          transparency obligations of an online service; and the French Consumer Code and Commercial
          Code for contracts, distance selling and pre-contractual information. Where you use the
          Service as a professional (a merchant), consumer-specific provisions do not apply to you;
          where you use it as a consumer, your mandatory rights are unaffected by these Terms.
        </p>
        <p>
