import type { SearchProvider } from '@/lib/leads/discovery/types';
import { SeedListProvider } from '@/lib/leads/discovery/seed';
import { BraveSearchProvider } from '@/lib/leads/discovery/brave';
