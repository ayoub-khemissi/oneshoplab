...
- Integration onboarding (2026-08-30): the wizard's step screenshots under
  `public/integrations/{woocommerce,shopify}/step-<n>.png` are grey placeholders
  generated by hand (800×450); the checklist of real captures to produce is in
  `docs/api/INTEGRATION-API.md` §9.
